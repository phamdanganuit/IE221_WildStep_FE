  ...
  return (
    <div className="space-y-4 sm:space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          <h1 className="text-xl sm:text-2xl lg:text-3xl font-bold text-gray-900">{t('dashboard.title')}</h1>
          <p className="text-sm sm:text-base text-gray-600 mt-1">{t('dashboard.subtitle')}</p>
        </div>
        <div className="flex gap-2 flex-wrap">
          <button
            onClick={() => setPeriod("week")}
            className={`px-3 py-2 sm:px-4 sm:py-2 rounded-lg text-xs sm:text-sm font-medium transition min-h-[44px] ${
              period === "week"
                ...
                <table className="min-w-full divide-y divide-gray-200">
                  <thead className="bg-gray-50">
                    <tr>
                      ...
                      <th className="px-3 py-3 sm:px-4 text-left text-xs sm:text-sm font-medium text-gray-600 uppercase tracking-wider hidden sm:table-cell">
